    ...
    class MainClass
    {
        public static void Main(string[] args)
        {
            ...
            while (userTypeeType != "q")
            {
                ...
                {
                    Console.WriteLine("I can't believe you got caught by a monster that moves randomly.");
                    ...
                    Console.WriteLine("You deserve this.");
                    Console.WriteLine("Press any key to exit...loser.");
                ...
                if (board[playerX, playerY] == board[tray1X, tray1Y])     //when user enters the same space that a treasure is in
                {
                    if (treasure1Found == false)             //denotes what happens the first time user enters this area, as bool was set to false
                    {
                        ...
                        Console.WriteLine("    '░▒▒▒▒▒▒▒╢╢▒▒▒▀▀██████████▀▀▒╣▒╫▒╬╢╣▒╢╣╬▒▒`   ");
                        Console.WriteLine("      `▒▒▒▒▒▒╣╢╢║╣╣▒╣▓█▒╫█▌╣╠╟╠╢▒╣╬▓╫╢╣ ▒▒▒▒`     ");
                        Console.WriteLine("           ║╢╢╢▒▒▒╬╬╫▒▒▒▒▒▒▒▒╬╢▒▒▒╣▒╫╢ ▒▒░        "); //tell user they found the treasure
            ...
            Console.WriteLine();
            Console.WriteLine("Blair Jones\nGret Bluemle\nMarc Guimond\nSean Lenhart\nJR Leonardi");
            //soundtrack: Childish Gambino
        }
